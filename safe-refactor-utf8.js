...
let code = fs.readFileSync('EspecieVegetalForm.bak.tsx', 'utf16le');

// Sometimes it has a BOM, we can strip it
...
// Ensure the final write is UTF8!
fs.writeFileSync('src/components/admin/EspecieVegetalForm.tsx', code, 'utf8');
console.log('Successfully applied all hooks and saved as UTF8.');
