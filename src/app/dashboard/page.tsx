...
export default function DashboardHome() {
  ...
  const [seedFormData, setSeedFormData] = useState({
    ...
    semillasstockinicial: 50,
    semillasstockactual: 50,
    semillasmarca: '',
    semillaslugarcompra: '',
  ...
  // Estados para calculadora de gramos a semillas
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '28px' }}>
              ...
              {seedStep === 2 && selectedEspecie && (
                <>
                  <button onClick={() => { setSeedStep(1); setSelectedVariedad(null); }}
                  ...
                  <h3 style={{ margin: '0 0 16px', color: '#0f172a', fontSize: '1.1rem', fontWeight: 800 }}>
                    {selectedEspecie.especiesicono} {selectedEspecie.especiesnombre} — Elige la variedad
                  </h3>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '14px' }}>
                    {catalogoVariedades.map(v => (
                      <button key={v.idvariedades} onClick={() => { setSelectedVariedad(v); setSeedStep(3); }}
                        style={{
                          background: selectedVariedad?.idvariedades === v.idvariedades ? '#f0fdfa' : 'white',
                          border: `2px solid ${selectedVariedad?.idvariedades === v.idvariedades ? '#0d9488' : '#e2e8f0'}`,
                      ...
                      >
                        ...
                        {v.foto ? (
                          ...
                          <span style={{ fontSize: '1.8rem' }}>{v.variedadesicono || selectedEspecie.especiesicono || '🌱'}</span>
                        )}
              ...
              {/* PASO 3: Detalles del lote */}
              {seedStep === 3 && selectedVariedad && (
                <>
                  <button onClick={() => setSeedStep(catalogoVariedades.length > 1 ? 2 : 1)}
                    style={{ background: 'none', border: 'none', color: '#64748b', cursor: 'pointer', marginBottom: '16px', fontSize: '0.85rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ← Volver
                  </button>
                  ...
                  <div style={{ display: 'grid', gap: '18px' }}>
                    ...
                    {/* Resumen */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', background: '#f0fdfa', border: '1px solid #ccfbf1', padding: '16px', borderRadius: '16px' }}>
                      <span style={{ fontSize: '2rem' }}>🌰</span>
                      <div>
                        <div style={{ fontSize: '0.75rem', color: '#0f766e', fontWeight: 800, textTransform: 'uppercase' }}>Variedad Seleccionada</div>
                        <h4 style={{ margin: 0, color: '#115e59', fontSize: '1.1rem', fontWeight: 900 }}>{selectedVariedad.variedadesnombre}</h4>
                      </div>
                      <div style={{ marginLeft: 'auto', background: '#ccfbf1', color: '#0f766e', padding: '4px 10px', borderRadius: '10px', fontSize: '0.8rem', fontWeight: 800 }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          onChange={e => setSeedFormData({ ...seedFormData, semillasstockactual: parseInt(e.target.value) || 0 })}
                          style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #cbd5e1', fontSize: '0.95rem', outline: 'none' }}
                        />
                      </div>
                    </div>

                    {/* Datos del sobre comprado */}
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px', background: '#f8fafc', padding: '16px', borderRadius: '12px', border: '1px dashed #cbd5e1' }}>
                        <div>
                          ...
                          <input 
                            ...
                            value={seedFormData.semillasmarca}
                            onChange={e => setSeedFormData({ ...seedFormData, semillasmarca: e.target.value })}
                        ...
                        <div>
                          ...
                          <input 
                            ...
                            value={seedFormData.semillaslugarcompra}
                            onChange={e => setSeedFormData({ ...seedFormData, semillaslugarcompra: e.target.value })}
                            style={{ width: '100%', padding: '8px', borderRadius: '8px', border: '1px solid #cbd5e1', fontSize: '0.9rem', outline: 'none' }}
                          />
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
                      <div>
                        ...
                        <input 
                          type="date"
                          value={seedFormData.semillasfechaenvasado}
                          onChange={e => setSeedFormData({ ...seedFormData, semillasfechaenvasado: e.target.value })}
                          style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #cbd5e1', fontSize: '0.95rem' }}
                        />
                      </div>
                      <div>
                        ...
                        <input 
                          type="date"
                          value={seedFormData.semillasfechacaducidad}
                          onChange={e => setSeedFormData({ ...seedFormData, semillasfechacaducidad: e.target.value })}
                          style={{ width: '100%', padding: '10px', borderRadius: '10px', border: '1px solid #cbd5e1', fontSize: '0.95rem' }}
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <textarea 
                        placeholder="Ej. Guardadas en botes herméticos con gel de sílice..."
                        value={seedFormData.semillasobservaciones}
                        onChange={e => setSeedFormData({ ...seedFormData, semillasobservaciones: e.target.value })}
                        style={{ width: '100%', padding: '12px', borderRadius: '10px', border: '1px solid #cbd5e1', fontSize: '0.95rem', minHeight: '80px', fontFamily: 'inherit', resize: 'vertical' }}
                      />
                    </div>
                    ...
                    >
                      {savingSeed ? '⏳ Guardando...' : '💾 Registrar Lote de Semillas'}
                    </button>
              ...
              {seedStep === 4 && (
                <div style={{ padding: '40px 20px', textAlign: 'center' }}>
                  ...
                  <p style={{ color: '#64748b', margin: 0, fontSize: '0.95rem', lineHeight: 1.5 }}>
                    El lote de <strong>{selectedVariedad?.variedadesnombre}</strong> se ha añadido correctamente a tu banco de semillas.
                  </p>
                </div>
              )}
