...
async function main() {
  ...
  try {
    ...
    console.log("Inyectando matriz de reglas...");
    for (const r of rules) {
      await connection.query(`
        INSERT INTO suscripcionesavisos (xsuscripcionesavisosidsuscripciones, xsuscripcionesavisosidtiposavisos, suscripcionesavisosestado)
        VALUES (?, ?, ?)
        ON DUPLICATE KEY UPDATE suscripcionesavisosestado = VALUES(suscripcionesavisosestado)
