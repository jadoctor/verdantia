...
- especiesbiodinamicacategoria (string, elige UNO entre: fruto, raiz, hoja, flor — según la parte comestible/ornamental principal. NOTA: este valor se almacenará como 'especiesorganocomestible' en la BD, pero devuélvelo con la clave 'especiesorganocomestible')
...
- especiespreparacionconvencional (entero aproximado en días de antelación necesarios para preparar el terreno en laboreo convencional, ej: 15)
