              ...
              <Link href={`/blog/${art.blogslug}`} key={art.idblog} style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                    <h2 style={{ margin: '0 0 10px', fontSize: '1.4rem', color: '#0f172a', lineHeight: 1.3 }}>{art.blogtitulo}</h2>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid #e2e8f0', paddingTop: '15px', marginTop: 'auto' }}>
                      ...
                      <span style={{ fontSize: '0.85rem', color: '#94a3b8' }}>{new Date(art.blogfechapublicacion).toLocaleDateString()}</span>
                    </div>
                  </div>
                </article>
              </Link>
