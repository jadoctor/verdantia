...
export default function VariedadVegetalMediaManager({ variedadId, userEmail, variedadNombre = 'Variedad', especieNombre = 'Especie', especieNombreCientifico = '', especieFamilia = '', section = 'all', onMediaChange, apiBasePath, initialEditPdfId, entityType = 'variedades' }: VariedadVegetalMediaManagerProps) {
