...
export const FRIENDLY_NAMES: Record<string, string> = {
  ...
  '/dashboard/admin/contenedores': '📦 Contenedores: Listado/Gestión',
  ...
  '/dashboard/admin/variedadesvegetales': '🍇 Variedades: Listado',
  ...
  '/dashboard/admin/especiesvegetales': '🌍 Especies vegetales: Listado',
  '/dashboard/admin/especiesvegetales/[id]': '🌍 Especies vegetales: Edición',
  ...
  '/dashboard/admin/especiesvegetales/nueva': '🌍 Especies vegetales: Creación',
  ...
  '/dashboard/admin/variedadesvegetales/[id]': '🍇 Variedades: Edición',
  '/dashboard/admin/usuarios/[id]': '👥 Usuarios: Detalle/Edición',
  '/dashboard/admin/contenedores/[id]': '📦 Contenedores: Detalle/Edición',
  ...
  '/dashboard/admin/tratamientos': '🧪 Tratamientos: Listado',
  '/dashboard/admin/tratamientos/[id]': '🧪 Tratamientos: Edición'
};
...
export const DASHBOARD_GROUPS = [
  ...
  { id: 'especies', label: '🌍 Especies vegetales' },
...
export const dashboards: DashboardItem[] = [
  { lines: 7109, path: '/dashboard/bancales/[id]', file: 'bancales/[id]/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  ...
  { lines: 996, path: '/dashboard/admin/blog/[id]', file: 'admin/blog/[id]/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 97, path: '/dashboard/admin/familias/[id]', file: 'admin/familias/[id]/page.tsx', refactoredAt: '2026-06-15', responsiveAt: '2026-06-15', premiumAt: null },
  { lines: 128, path: '/dashboard/admin/mantenimiento/analisis', file: 'admin/mantenimiento/analisis/page.tsx', refactoredAt: '13/06/2026', responsiveAt: '13/06/2026', premiumAt: null },
  { lines: 134, path: '/dashboard/admin/mantenimiento', file: 'admin/mantenimiento/page.tsx', refactoredAt: '13/06/2026', responsiveAt: '13/06/2026', premiumAt: null },
  { lines: 560, path: '/dashboard/cultivos', file: 'cultivos/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 130, path: '/dashboard/admin/mantenimiento/biblia', file: 'admin/mantenimiento/biblia/page.tsx', refactoredAt: '13/06/2026', responsiveAt: '13/06/2026', premiumAt: null },
  { lines: 486, path: '/dashboard/onboarding', file: 'onboarding/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 91, path: '/dashboard/admin/fases/[id]', file: 'admin/fases/[id]/page.tsx', refactoredAt: '13/06/2026', responsiveAt: null, premiumAt: null },
  { lines: 447, path: '/dashboard/semillas', file: 'semillas/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 439, path: '/dashboard/comunidad', file: 'comunidad/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 62, path: '/dashboard/admin/familias', file: 'admin/familias/page.tsx', refactoredAt: '2026-06-15', responsiveAt: '2026-06-15', premiumAt: null },
  { lines: 383, path: '/dashboard/cultivos/[id]', file: 'cultivos/[id]/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 327, path: '/dashboard/admin/usuarios', file: 'admin/usuarios/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 286, path: '/dashboard/admin/ajustes/avisos', file: 'admin/ajustes/avisos/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 280, path: '/dashboard/admin/ajustes/logros', file: 'admin/ajustes/logros/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 273, path: '/dashboard/admin/plagas', file: 'admin/plagas/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  ...
  { lines: 149, path: '/dashboard/admin/ajustes/idiomas', file: 'admin/ajustes/idiomas/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  ...
  { lines: 60, path: '/dashboard/admin/tratamientos', file: 'admin/tratamientos/page.tsx', refactoredAt: '28/06/2026', responsiveAt: null, premiumAt: '28/06/2026' },
  { lines: 13, path: '/dashboard/tareas', file: 'tareas/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 12, path: '/dashboard/admin/variedadesvegetales/[id]', file: 'admin/variedades/[id]/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null },
  { lines: 6, path: '/dashboard/admin/ajustes', file: 'admin/ajustes/page.tsx', refactoredAt: null, responsiveAt: null, premiumAt: null }
];
